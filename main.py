array_cofres = ["velkoz", "samira", "blitzcrank", "graves", "zed", "xayah", "vayne", "varus", "tristana", "senna", "quinn", "miss fortune", "lux", "lucian", "kalista", "kaisa", "jinx", "jhin", "gnar", "ezreal", "caitlyn", "bardo", "ashe", "aphelios", "akshan"]
...
campeon = input("Ingrese nombre campeon: ")
